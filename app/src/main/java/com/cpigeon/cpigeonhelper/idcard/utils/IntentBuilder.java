...
import com.cpigeon.cpigeonhelper.message.base.FragmentParentActivity;
import com.cpigeon.cpigeonhelper.message.base.BaseFragment;
...
public class IntentBuilder {
    ...
    public static final int REQUEST_CODE_RELOAD = 0x456;
    ...
    private
    @AnimRes
    int animOpen = R.anim.anim_right_in;
    private
    @AnimRes
    int animExit = R.anim.anim_left_out;
