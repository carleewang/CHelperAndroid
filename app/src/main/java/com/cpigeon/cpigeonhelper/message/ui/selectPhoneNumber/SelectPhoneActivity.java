...
import com.cpigeon.cpigeonhelper.message.ui.selectPhoneNumber.widget.TouchableRecyclerView;
...
public class SelectPhoneActivity extends BaseActivity<SelectPhonePre> {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        searchEditText = (SearchEditText) findViewById(R.id.widget_title_bar_search);
