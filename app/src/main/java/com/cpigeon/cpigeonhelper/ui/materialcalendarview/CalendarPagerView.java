...
import static com.cpigeon.cpigeonhelper.ui.materialcalendarview.MaterialCalendarView.SHOW_DEFAULTS;
import static com.cpigeon.cpigeonhelper.ui.materialcalendarview.MaterialCalendarView.showOtherMonths;
        ...
        for (DayView dayView : dayViews) {
            ...
            for (DecoratorResult result : decoratorResults) {
                if (result.decorator.shouldDecorate(dayView.getDate())) {
                    ...
                    dayView.setTextColor(getContext().getResources().getColor(R.color.sign_color));
