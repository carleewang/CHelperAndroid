...
public class PayPwdInputFragment extends DialogFragment {
    ...
    private TextView tv_forget_paypwd;//忘记密码
    private TextView tv_yue_prompt;//支付金额
...
//                    startActivity(intent);
                    ...
                    intent.putExtra(EXTRA_URL, ApiConstants.BASE_URL + ApiConstants.WHAT_PLAY_PAS);
                    startActivity(intent);
                    break;
                case R.id.tv_forget_paypwd://忘记支付密码
                    intent = new Intent(getActivity(), PlaySMSvalidationActivity.class);
                    intent.putExtra("startActivityTag", 1);//1:支付页面修改密码
                    startActivity(intent);
                    break;
            }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.layou_paly_dialog);
