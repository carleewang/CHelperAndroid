                        ...
                        if (listApiResponse.getErrorCode() == 0) {
                            if (listApiResponse.getData().size() > 0) {
                                ...
                                for (int i = 0; i < listApiResponse.getData().size(); i++) {
                                    //                        if (listApiResponse.getData().get(i).getStatusname().equals("交易完成")) {
                                    if (listApiResponse.getData().get(i).getDdzt() == 1) {
                            ...
                            errSweetAlertDialog = SweetAlertDialogUtil.showDialog(errSweetAlertDialog, msg, AlreadyOrderFragment.this.getActivity(), dialog -> {
                                dialog.dismiss();
                                //跳转到登录页
