...
import com.cpigeon.cpigeonhelper.modular.myserver.xh.wdhy.view.adapter.YearSelectionAdapter;
...
public class YearSelectionListActivity extends ToolbarBaseActivity {
    ...
    private YearSelectionAdapter mAdapter;
    ...
    protected void setStatusBar() {
        ...
        setTopLeftButton(R.drawable.ic_back, YearSelectionListActivity.this::finish);

        mHyUserDetailEntity = (HyUserDetailEntity) getIntent().getSerializableExtra("data");


        if (mHyUserDetailEntity != null) {
            setTitle(String.valueOf(mHyUserDetailEntity.getBasicinfo().getName() + "年度评选"));
        } else {
            setTitle("年度评选");
        }
        ...
        if (type.equals("myself") && !mHyUserDetailEntity.getZhuangtai().equals("除名")) {
            setTopRightButton(R.mipmap.top_add, () -> {
                //年度评选添加
                Intent intent = new Intent(YearSelectionListActivity.this, YearSelectionAddActivity.class);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        mMemberPresenter = new MemberPresenter(new MenberViewImpl() {
            ...
            public void getXHHYGL_NDPX_GetListData(ApiResponse<List<YearSelectionEntitiy>> listApiResponse, String msg, Throwable mThrowable) {
                super.getXHHYGL_NDPX_GetListData(listApiResponse, msg, mThrowable);
                try {
                    ...
                    if (mThrowable != null) {//抛出异常
                        ...
                        if (listApiResponse.getErrorCode() == 0) {
                            ...
                            errSweetAlertDialog = SweetAlertDialogUtil.showDialog(errSweetAlertDialog, msg, YearSelectionListActivity.this, dialog -> {
                                dialog.dismiss();
                                //跳转到登录页
    ...
    public void onEventMainThread(String strRefresh) {
        if (strRefresh.equals(EventBusService.YEAR_SELECTION_LIST_REFRESH)) {
            againRequest();
        }
    }
    ...
    private void showErrorView() {
        SwipeRefreshUtil.swipeRefreshLayoutCustom(mSwipeRefreshLayout, mCustomEmptyView, mRecyclerView, R.string.str_hint_hygl_ndpx);
    }
    ...
    private void againRequest() {
        try {
            ...
            mAdapter.notifyDataSetChanged();
            mMemberPresenter.getXHHYGL_NDPX_GetList(mHyUserDetailEntity.getBasicinfo().getMid(), pi, ps,mHyUserDetailEntity.getBasicinfo().getXhuid(),type);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void initRecyclerView() {
        mAdapter = new YearSelectionAdapter(null, mHyUserDetailEntity,type);
