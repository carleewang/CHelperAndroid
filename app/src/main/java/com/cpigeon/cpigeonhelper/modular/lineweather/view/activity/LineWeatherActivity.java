...
import com.cpigeon.cpigeonhelper.ui.guideview.Component;
import com.cpigeon.cpigeonhelper.ui.guideview.GuideBuilder;
...
import com.cpigeon.cpigeonhelper.utils.guide.GuideManager;
...
import static com.cpigeon.cpigeonhelper.utils.CommonUitls.Aj2GPSLocation;
import static com.cpigeon.cpigeonhelper.utils.CommonUitls.GPS2AjLocation;
...
//        toolbar.getMenu().add("").setIcon(R.drawable.ic_share_line_weather).setOnMenuItemClickListener(item -> {
        ...
        etSfdLo1.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etSfdLo1, 1, etSfdLo2));
        etSfdLo2.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etSfdLo2, 3, etSfdLo3));
        etSfdLo3.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etSfdLo3, 4, etSfdLa1));

        etSfdLa1.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etSfdLa1, 2, etSfdLa2));
        etSfdLa2.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etSfdLa2, 3, etSfdLa3));
        etSfdLa3.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etSfdLa3, 4, etSfdLa3));

        etGcdLo1.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etGcdLo1, 1, etGcdLo2));
        etGcdLo2.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etGcdLo2, 3, etGcdLo3));
        etGcdLo3.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etGcdLo3, 4, etGcdLa1));

        etGcdLa1.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etGcdLa1, 2, etGcdLa2));
        etGcdLa2.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etGcdLa2, 3, etGcdLa3));
        etGcdLa3.addTextChangedListener(UlageToolPresenter.setLoLaSListener(mContext, etGcdLa3, 4, etGcdLa3));
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_sure:
                if (sureSfdLa == -1 || sureSfdLo == -1) {
                    CommonUitls.showToast(this, "请选择司放地点");
                    return;
                }
                if (sureGcdLa == -1 || sureGcdLo == -1) {
                    CommonUitls.showToast(this, "请选择归巢地点");
                    return;
                }
...
//                break;
            ...
            case R.id.ll_click_sfd_sure:
                ...
                CommonUitls.showToast(LineWeatherActivity.this, "选择地图定位 （司放地）");
                selectAnchorPoint(1);
                break;
            ...
            case R.id.ll_click_gcd_sure:
                ...
                CommonUitls.showToast(LineWeatherActivity.this, "选择地图定位（归巢地）");
                selectAnchorPoint(2);
                break;
    ...
    private void startGeocodeSearch(String name, int tag) {
        ...
        if (name.isEmpty()) {
            CommonUitls.showToast(this, "输入地址不能为空");
            return;
        }
    ...
    private void startCoordinateLocate(EditText etLo1, EditText etLo2, EditText etLo3,
        ...
        if (strEtLo1.isEmpty() || strEtLo2.isEmpty() || strEtLo3.isEmpty() ||
            ...
            CommonUitls.showToast(this, "输入经纬度内容不能为空");
            return;
        }
        ...
        try {
            double la = Aj2GPSLocation(Double.valueOf(strLa));
            double lo = Aj2GPSLocation(Double.valueOf(strLo));
            ...
            public void onMapScreenShot(Bitmap bitmap, int status) {
                ...
                try {
                    ...
                    if (dialogFragment != null) {
                        ...
                        dialogFragment.setShareListener(ViewControlShare.getShareResultsDown(LineWeatherActivity.this, dialogFragment, "tp"));
                        dialogFragment.setShareType(3);
                        dialogFragment.show(LineWeatherActivity.this.getFragmentManager(), "share");
                    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (resultCode == 0x0033) {
                ...
                sureSfdLo = CommonUitls.Aj2GPSLocation(Double.valueOf(mData.getLo()));
                sureSfdLa = CommonUitls.Aj2GPSLocation(Double.valueOf(mData.getLa()));
