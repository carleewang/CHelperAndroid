...
// */
//
//public class ShootAnytimeActivity extends Activity implements View.OnTouchListener, SensorControler.CameraFocusListener {
//
...
//        //初始化定位相关数据
//        MapUtil.noViewContinuousLocalize(mLocationClient, mLocationListener);
//
...
//
//            if (type.equals("photo")) {
//                intent1 = new Intent(ShootAnytimeActivity.this, PhotoEditActivity.class);
//            }
//            intent1.putExtra("img_path", img_path);
//            startActivity(intent1);
//
//            ShootAnytimeActivity.this.finish();
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
...
//                            public void run() {
//                                try {
//                                    Intent intent = new Intent(ShootAnytimeActivity.this, VideoEditActivity.class);
//                                    intent.putExtra("video_path", path);
//                                    intent.putExtra("label_tag", getIntent().getStringExtra("label_tag"));
...
//
//                            imgbtn_false();
//                            Toast.makeText(ShootAnytimeActivity.this, "录像时间太短", Toast.LENGTH_SHORT).show();
//                        }
//                    });
//                } else {
//                    runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
//                            ShootAnytimeActivity.this.imgbtn_false.setVisibility(View.VISIBLE);//取消显示
//                            ShootAnytimeActivity.this.imgbtn_ture.setVisibility(View.VISIBLE);//确定显示
//                            ShootAnytimeActivity.this.btn_paizhao.setVisibility(View.INVISIBLE);//拍照隐藏
...
//        mweathersearch = new WeatherSearch(ShootAnytimeActivity.this);
//
...
//
////            Log.d("myhaiba", "aMapLocationSucceed:1 "+ aMapLocation.getAltitude());
////
////            //获取海拔高度
...
////
////            if (location == null || location.getAltitude() == 0) {
////                Log.d("myhaiba", "aMapLocationSucceed:2 ");
////                watermarkHb.setText("海拔：0米");
////            } else {
////                Log.d("myhaiba", "aMapLocationSucceed:3 "+ CommonUitls.strTwo(location.getAltitude()));
...
//                                    //图片保存
//                                    BitmapUtils.saveJPGE_After(ShootAnytimeActivity.this, BitmapUtils.createBitmapCenter(BitmapUtils.createBitmapLowerLeft(BitmapUtils.rotaingImageView(90, BitmapFactory.decodeByteArray(data, 0, data.length)), BitmapUtils.convertViewToBitmap(watermarkLlz)), BitmapUtils.convertViewToBitmap(waterCenImg)), img_path, 85);
//                                }
//                            });
//                        }
//                    });
