...
public class MyWheelTime {
    ...
    private MyWheelView wv_seconds;
    private int gravity;
...
//    float lineSpacingMultiplier = 1.6F;
    float lineSpacingMultiplier = 5F;
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        // 年
        wv_year = (MyWheelView) view.findViewById(R.id.year);
        ...
        // 月
        wv_month = (MyWheelView) view.findViewById(R.id.month);
        ...
        // 日
        wv_day = (MyWheelView) view.findViewById(R.id.day);
        ...
        wv_seconds = (MyWheelView) view.findViewById(R.id.second);
...
//                maxItem = endD;
     ...
     * @param dividerType
     */
    public void setDividerType(MyWheelView.DividerType dividerType) {
