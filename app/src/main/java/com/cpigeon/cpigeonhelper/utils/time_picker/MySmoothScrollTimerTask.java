 ...
 * @author 小嵩
 */
final class MySmoothScrollTimerTask extends TimerTask {
    ...
    MySmoothScrollTimerTask(MyWheelView loopview, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 1) {
            ...
            loopView.handler.sendEmptyMessage(MyMessageHandler.WHAT_ITEM_SELECTED);
        } else {
            ...
            loopView.handler.sendEmptyMessage(MyMessageHandler.WHAT_INVALIDATE_LOOP_VIEW);
