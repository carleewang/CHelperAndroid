 ...
 */
public class MyTimePickerViewYMD extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public MyTimePickerViewYMD(Builder builder) {
    ...
    public static class Builder {
        ...
        public MyTimePickerViewYMD build() {
            return new MyTimePickerViewYMD(this);
        }
    }
