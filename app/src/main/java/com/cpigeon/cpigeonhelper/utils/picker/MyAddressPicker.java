...
public class MyAddressPicker extends LinkagePicker<Province, City, County> {
    private MyAddressPicker.OnAddressPickListener onAddressPickListener;
    private MyAddressPicker.OnWheelListener onWheelListener;
    //只显示地市及区县
    ...
    public MyAddressPicker(Activity activity, ArrayList<Province> provinces) {
        super(activity, new MyAddressPicker.AddressProvider(provinces));
     ...
     * 设置滑动监听器
     */
    public void setOnWheelListener(MyAddressPicker.OnWheelListener onWheelListener) {
        this.onWheelListener = onWheelListener;
    }

    public void setOnAddressPickListener(MyAddressPicker.OnAddressPickListener listener) {
        this.onAddressPickListener = listener;
    }

    /**
     * @deprecated use {@link #setOnAddressPickListener(MyAddressPicker.OnAddressPickListener)} instead
     */
    @Deprecated
    @Override
