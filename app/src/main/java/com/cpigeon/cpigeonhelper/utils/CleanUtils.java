...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(MyApplication.getInstance().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(MyApplication.getInstance().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(MyApplication.getInstance().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return MyApplication.getInstance().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return deleteFilesInDir(MyApplication.getInstance().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && deleteFilesInDir(MyApplication.getInstance().getExternalCacheDir());
    }
